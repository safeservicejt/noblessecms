...
<div class="row">
		...
		<div class="col-lg-12">
			...
			<div class="row" style="margin-bottom:50px;">
				...
				<div class="row">
					<div class="col-lg-12">
					<a href="<?php echo System::getUrl();?>npanel/theme/setting/<?php echo System::getThemeName();?>" class="btn btn-primary">Setting</a>
					<a href="<?php echo System::getUrl();?>npanel/theme/edit/<?php echo System::getThemeName();?>" class="btn btn-danger">Edit</a>
				...
				<div class="col-lg-3 themeCol">
					<div class="row">
						...
						<div class="col-lg-12 themeButton">
							<a href="<?php echo System::getUrl();?>npanel/theme/activate/<?php echo $themeNames[$i];?>" class="btn btn-primary">Activate</a>
						<a href="<?php echo System::getUrl();?>npanel/theme/setting/<?php echo $themeNames[$i];?>" class="btn btn-warning pull-right">Setting</a>
						</div>
					</div>
				</div>
