...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<?php echo System::getUrl();?>bootstraps/sbnoblesse/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<?php echo System::getUrl();?>bootstraps/sbnoblesse/css/sb-admin.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="<?php echo System::getUrl();?>bootstraps/sbnoblesse/css/plugins/morris.css" rel="stylesheet">

    <link href="<?php echo System::getUrl();?>bootstraps/sbnoblesse/css/custom.css" rel="stylesheet">

    <link href="<?php echo System::getUrl();?>bootstraps/css/animate-animo.min.css" rel="stylesheet">
    
    <link rel="stylesheet" href="<?php echo ROOT_URL;?>bootstraps/jsupload/css/jquery.fileupload.css">   

    <!-- Custom Fonts -->
    <link href="<?php echo System::getUrl();?>bootstraps/sbnoblesse/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">

    <?php echo System::getVar('cssGlobal','global',true);?>

    <!-- jQuery -->
    <script src="<?php echo System::getUrl();?>bootstraps/js/jquery-2.1.3.min.js"></script>
    <script src="<?php echo System::getUrl();?>bootstraps/js/animo.min.js"></script>
    <script src="<?php echo System::getUrl();?>bootstraps/js/system.js"></script>
    ...
    <?php echo System::getVar('admincp_header','global',true);?>
...
<img src="<?php echo System::getUrl();?>bootstraps/images/addnew.png" class=" img-tools" />
            ...
            <div class="modal-body modal-body-tools">
                ...
                <div class="row row-tools">
                    <div class="col-lg-2 col-md-2 col-sm-4 text-center">
                        <p>
                            <a href="<?php echo System::getAdminUrl();?>post/addnew"><img src="<?php echo System::getUrl();?>bootstraps/images/tools/post.png" class="img-responsive the-tool" /></a>
                        </p>
                        <a href="<?php echo System::getAdminUrl();?>post/addnew" class="a-the-tool">New Post</a>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4  text-center">
                        <p>
                            <a href="<?php echo System::getAdminUrl();?>categories"><img src="<?php echo System::getUrl();?>bootstraps/images/tools/category.png" class="img-responsive the-tool" /></a>
                        </p>
                        <a href="<?php echo System::getAdminUrl();?>categories" class="a-the-tool">New Category</a>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4  text-center">
                        <p>
                            <a href="<?php echo System::getAdminUrl();?>pages/addnew"><img src="<?php echo System::getUrl();?>bootstraps/images/tools/page.png" class="img-responsive the-tool" /></a>
                        </p>
                        <a href="<?php echo System::getAdminUrl();?>pages/addnew" class="a-the-tool">New Page</a>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4  text-center">
                        <p>
                            <a href="<?php echo System::getAdminUrl();?>links"><img src="<?php echo System::getUrl();?>bootstraps/images/tools/link.png" class="img-responsive the-tool" /></a>
                        </p>
                        <a href="<?php echo System::getAdminUrl();?>links" class="a-the-tool">New Link</a>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4  text-center">
                        <p>
                            <a href="<?php echo System::getAdminUrl();?>setting"><img src="<?php echo System::getUrl();?>bootstraps/images/tools/setting.png" class="img-responsive the-tool" /></a>
                        </p>
                        <a href="<?php echo System::getAdminUrl();?>setting" class="a-the-tool">Settings</a>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4  text-center">
                        <p>
                            <a href="<?php echo System::getAdminUrl();?>theme"><img src="<?php echo System::getUrl();?>bootstraps/images/tools/theme.png" class="img-responsive the-tool" /></a>
                        </p>
