    ...
    <div class="row">
        ...
        <?php if(!Uri::has('\/edit\/\d+')){ ?>
            ...
            <?php echo $alert;?>
                ...
                <p>
                    <label><strong>Url</strong></label>
                    <input type="text" class="form-control" name="send[from_url]" placeholder="/post/test_post.html" id="txtTitle" value="<?php echo $edit['from_url'];?>" />
                </p>
                <p>
                    <label><strong>To url</strong></label>
                    <input type="text" class="form-control" name="send[to_url]" placeholder="http://google.com/" id="txtTitle" value="<?php echo $edit['to_url'];?>" />
                </p>
                <p>
                    <label><strong>Status</strong></label>
                    <select class="form-control" name="send[status]">
                        <option value="1" <?php if((int)$edit['status']==1)echo 'selected';?>>Enable</option>
                        <option value="0" <?php if((int)$edit['status']==0)echo 'selected';?>>Disable</option>
                    </select>
                </p>
