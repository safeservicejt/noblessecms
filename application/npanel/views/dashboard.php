  ...
  <div class="panel-body">
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <img src="<?php echo System::getUrl();?>bootstraps/images/logo3128.png" />
            <?php }else{ ?>
...
<div class="panel panel-default">
  <div class="panel-body">
    ...
    <div class="row">
        ...
        <h4>Page</h4> 
        <ul class="ulDashboard">
        <li><a href=""><span class="glyphicon glyphicon-th-large"></span> Today page: <span id="todayComment"><?php echo $page['today'];?></span></a></li>
       <li><a href=""><span class="glyphicon glyphicon-th-large"></span> Total page: <span id="totalComment"><?php echo $page['total'];?></span></a></li>
