    					...
    					<?php
    						...
    						for ($i=0; $i < $total; $i++) { 
	    						...
	    						<tr>
                                    ...
                                    <td class="col-lg-5"><a href="'.$theList[$i]['url'].'" target="_blank">'.$theList[$i]['title'].'</a>
                                    <br>
                                    '.$allowcomment.' '.$dateAdded.' '.$views.'
                                    </td>
                                    <td class="col-lg-1 text-right">'.$status.'</td>
                                    <td class="col-lg-1 text-right">
                                    <a href="'.System::getAdminUrl().'pages/edit/'.$theList[$i]['id'].'" class="btn btn-warning btn-xs">Edit</a>
                                    </td>
	    						</tr>    						
	    						<!-- tr -->
    							';
