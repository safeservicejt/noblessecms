...
<!-- Form Action -->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				{
					$status='<a href="'.System::getUrl().'npanel/plugins/uninstall/'.$theList[$i]['foldername'].'">Uninstall</a>';		

					$activate='<a href="'.System::getUrl().'npanel/plugins/deactivate/'.$theList[$i]['foldername'].'">Deactivate</a>&nbsp;&nbsp;&nbsp;';	
					...
					if((int)$theList[$i]['install'] == 0)
					{
						...
						$status='<a href="'.System::getUrl().'npanel/plugins/install/'.$theList[$i]['foldername'].'">Install</a>';						
					}
					if((int)$theList[$i]['setting'] == 1 && (int)$theList[$i]['install']==1)
					{
			
						$pluginSetting='<a href="'.System::getUrl().'npanel/plugins/setting/'.$theList[$i]['foldername'].'">Setting</a>&nbsp;&nbsp;&nbsp;';						
					}

					if((int)$theList[$i]['status'] == 0 && (int)$theList[$i]['install']==1)
					{
			
						$activate='<a href="'.System::getUrl().'npanel/plugins/activate/'.$theList[$i]['foldername'].'">Activate</a>&nbsp;&nbsp;&nbsp;';		
