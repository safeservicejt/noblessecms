			...
			<div role="tabpanel">
			    ...
			    <div role="tabpanel" class="tab-pane active" id="general">
			    	...
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		...
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_view_post]" value="1" checked data-toggle="toggle">
			    		</div>
			  ...
			  <!-- usercpAccess -->
			    <div role="tabpanel" class="tab-pane" id="post">
			    	...
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		...
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_manage_post]" value="1" checked data-toggle="toggle">
			    		</div>
			    		...
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_manage_comment]" value="1" checked data-toggle="toggle">
			    		</div>
			    	...
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		...
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_addnew_post]" value="1" checked data-toggle="toggle">
			    		</div>
			    	...
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		...
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_editall_post]" value="1" checked data-toggle="toggle">
			    		</div>
			    	...
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		...
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_delete_post]" value="1" checked data-toggle="toggle">
			    		</div>
			    	...
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		...
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[default_post_status]" value="0" checked data-toggle="toggle">
			    		</div>
			  ...
			  <!-- category -->
			    <div role="tabpanel" class="tab-pane" id="category">
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		...
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_manage_category]" value="1" checked data-toggle="toggle">
			    		</div>
			    	...
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		...
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_addnew_category]" value="1" checked data-toggle="toggle">
			    		</div>
			    	...
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		...
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_edit_category]" value="1" checked data-toggle="toggle">
			    		</div>
			    	...
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		...
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_delete_category]" value="1" checked data-toggle="toggle">
			    		</div>
			  ...
			  <!-- page -->
			    <div role="tabpanel" class="tab-pane" id="page">
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		...
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_manage_page]" value="1" checked data-toggle="toggle">
			    		</div>
			    	...
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		...
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_addnew_page]" value="1" checked data-toggle="toggle">
			    		</div>
			    	...
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		...
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_edit_page]" value="1" checked data-toggle="toggle">
			    		</div>
			    	...
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		...
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_delete_page]" value="1" checked data-toggle="toggle">
			    		</div>
			  ...
			  <!-- usergroups -->
			    <div role="tabpanel" class="tab-pane" id="usergroups">
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		<div class="col-lg-10">
			    		<strong>Can manage usergroups ?</strong>
			    		<br>
			    		User can manage, add new, edit usergroups follow your below select if this option is turn ON
			    		</div>
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_manage_usergroups]" value="1" checked data-toggle="toggle">
			    		</div>

			    	</div>
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		<div class="col-lg-10">
			    		<strong>Can add new usergroups ?</strong>
			    		</div>
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_addnew_usergroups]" value="1" checked data-toggle="toggle">
			    		</div>

			    	</div>
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		<div class="col-lg-10">
			    		<strong>Can edit usergroups ?</strong>
			    		</div>
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_edit_usergroups]" value="1" data-toggle="toggle">
			    		</div>

			    	</div>
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		<div class="col-lg-10">
			    		<strong>Can delete usergroups ?</strong>
			    		</div>
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_delete_usergroups]" value="1" data-toggle="toggle">
			    		</div>
			    ...
			    <div role="tabpanel" class="tab-pane" id="ecommerce">
			    	...
			    	<div class="row" style="margin-top:10px;margin-bottom:10px;">
			    		...
			    		<div class="col-lg-2 text-right">
							<input type="checkbox" name="groupdata[can_manage_all_product]" value="1" checked data-toggle="toggle">
			    		</div>
