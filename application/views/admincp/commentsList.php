    				...
    				<table class="table table-hover">
    					<thead>
    						<tr>
                                ...
                                <td class="col-lg-9">Post title</td>
    					...
    					<?php
    						...
    						for ($i=0; $i < $total; $i++) { 
	    						...
	    						<tr>
                                    <td class="col-lg-1">
                                        <input type="checkbox" id="cboxID" name="id[]" value="'.$theList[$i]['commentid'].'" />
                                    </td>
 	    							<td class="col-lg-2">
                                    ...
                                    <br>
                                    <span>Fullname: '.$theList[$i]['fullname'].'</span> <span>Email: '.$theList[$i]['email'].'</span>
                                    </td>
