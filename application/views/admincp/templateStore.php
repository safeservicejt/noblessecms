...
<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">Lastest Templates</h3>
  </div>
  ...
  <div class="row">
  	...
  	{
  		$li='<strong style="margin-left:15px;">There not have any template for download.</strong>';
  	}
...
$(document).ready(function(){
	...
	$('button.btnDownloadTemplate').click(function(){
		if(confirm('Are you wanna download this theme ?'))
		{
			...
			$.ajax({
		   type: "POST",
		   url: root_url+'api/download/template',
		   data: ({
				  fileUrl : theUrl,
				  fileTitle : theTitle
				  }),
		   ...
		   success: function(msg)
							{
								 ...
								 {
								 	alert('Success. Check you theme list for see this theme');
