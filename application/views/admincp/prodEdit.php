...
<!-- row -->
			...
			<input type="text" name="tags" class="form-control" value="<?php echo $tags;?>" placeholder="Tags..." />
				...
				<input type="text" class="form-control txtAuto" data-maxselect="1000" data-numselected="0" data-method="category" data-key="jsonCategory" placeholder="Type here..." />
                  ...
                  $total=count($selectCategories);

                  $li='';

                  if(isset($selectCategories[0]['cattitle']))
                  for($i=0;$i<$total;$i++)
                  {
                  	$li.='
					<li>
					<span class="textChosen">'.$selectCategories[$i]['cattitle'].'</span>
					<span title="Remove this" class="removeTextChosen">[x]</span>
					<input type="hidden" name="catid[]" class="valueChosen" value="'.$selectCategories[$i]['id'].'">
					</li> 
				...
				<input type="text" class="form-control txtAuto" data-maxselect="1000" data-numselected="0" data-method="page" data-key="jsonPage" placeholder="Type here..." />
	              <div class="listAutoSuggest"><ul></ul></div>	
                  <ul class="ulChosen">
                  <?php 

                  $total=count($selectPages);

                  $li='';

                  if(isset($selectPages[0]['title']))
                  for($i=0;$i<$total;$i++)
                  {
                  	$li.='
					<li>
					<span class="textChosen">'.$selectPages[$i]['title'].'</span>
					<span title="Remove this" class="removeTextChosen">[x]</span>
					<input type="hidden" name="pageid[]" class="valueChosen" value="'.$selectPages[$i]['id'].'">
					</li> 
				...
				<input type="text" class="form-control txtAuto" data-maxselect="1" data-numselected="0" data-method="manufacturer" data-key="jsonManufacturer" placeholder="Type here..." />
                  ...
                  <ul class="ulChosen">
                   ...
                   if(isset($edit['manufacturer_title']))
                   {
						...
						<span title="Remove this" class="removeTextChosen">[x]</span>
						<input type="hidden" name="manufacturerid" class="valueChosen" value="'.$edit['manufacturerid'].'">
						</li> 
				...
				<input type="text" class="form-control txtAuto" data-maxselect="1000" data-numselected="0" data-method="download" data-key="jsonDownload" placeholder="Type here..." />
                  ...
                  for($i=0;$i<$total;$i++)
                  {
					...
					<span title="Remove this" class="removeTextChosen">[x]</span>
					<input type="hidden" name="downloadid[]" class="valueChosen" value="'.$selectDownloads[$i]['id'].'">
					</li> 
...
<!-- 				  <div role="tabpanel" class="tab-pane" id="attribute">
		...
		<p>
			<label><strong>Quantity:</strong></label>
			<input type="text" name="send[quantity_discount]" class="form-control" value="<?php echo Render::numberFormat($edit['quantity_discount']);?>" placeholder="Quantity..." />
			</p>
		<p>
			<label><strong>Price:</strong></label>
