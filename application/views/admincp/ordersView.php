<div class="panel panel-default">
  <div class="panel-heading">
    ...
    <a href="<?php echo ADMINCP_URL;?>orders/approve/<?php echo $orders['orderid'];?>" class="btn btn-primary btn-xs">Approve Order</a>
      <?php } ?>
 ...
 <div class="row">
		...
		<div class="col-lg-12">
		<p>
		<strong>Ip Submit: <?php echo $orders['ip'];?></strong>
		</p>
		<p>
		...
		<thead>
			...
			<td class="col-lg-4">Total price</td>
			</tr>
		</thead>
