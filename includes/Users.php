...
class Users
{
	...
	public static function get($inputData=array())
	{
		...
		$field="userid,prefix,groupid,username,firstname,lastname,image,email,password,userdata,ip,verify_code,parentid,date_added,forgot_code,forgot_date".$moreFields;
