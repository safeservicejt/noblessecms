...
class ProductPages
{
	...
	public static function get($inputData=array())
	{
		...
		if($cache=='yes')
		{
			...
			$loadCache=Cache::loadKey('dbcache/system/productpage/'.$md5Query,$cacheTime);
		...
		// Save dbcache
		Cache::saveKey('dbcache/system/productpage/'.$md5Query,serialize($result));
	...
	public static function insert($inputData=array())
	{
		...
		Database::query("insert into products_pages($insertKeys) values".$addMultiAgrs);
	...
	public static function update($listID,$post=array(),$whereQuery='',$addWhere='')
	{
		...
		Database::query("update products_pages set $setUpdates where $whereQuery $addWhere");
