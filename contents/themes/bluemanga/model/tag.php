...
function listManga($keyword)
{
  ...
  $summaryQuery="select m.*,a.title as tag_title from manga_list m, manga_tags a where a.title LIKE '%$keyword%' AND m.mangaid=a.mangaid group by m.mangaid order by m.mangaid desc";
