...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 30, 2015 at 10:14 AM
...
CREATE TABLE IF NOT EXISTS `fastbb_files` (
  ...
  `post_type` varchar(30) NOT NULL DEFAULT 'thread',
...
--
-- Table structure for table `fastbb_forum_permission`
--

CREATE TABLE IF NOT EXISTS `fastbb_forum_permission` (
  `id` int(9) NOT NULL AUTO_INCREMENT,
  `groupid` int(9) NOT NULL,
  `keyname` varchar(255) NOT NULL,
  `keyvalue` varchar(255) DEFAULT NULL,
  `keydate` datetime DEFAULT NULL,
  `keyint` int(9) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
