...
<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">Edit chapter</h3>
  </div>
...
<div class="row">
        ...
        <input type="text" class="form-control txtAuto" data-maxselect="1" data-numselected="0" data-method="manga" data-key="get_list_manga" placeholder="Type manga name here..." />
                <div class="listAutoSuggest"><ul></ul></div>  
                  <ul class="ulChosen">
                  <?php if(isset($edit['manga_title'])){ ?>
                  <li>
                  <span class="textChosen"><?php echo $edit['manga_title'];?></span>
                  <span title="Remove this" class="removeTextChosen">[x]</span>
                  <input type="hidden" name="send[mangaid]" class="valueChosen" value="<?php echo $edit['mangaid'];?>">
                  </li>    
                <?php } ?>                      
                  </ul>
        </div>
      ...
      <input type="text" name="send[title]" class="form-control" value="<?php echo $edit['title'];?>" placeholder="Title..." />
      </p>
			<p>
			<label><strong>Chapter number:</strong></label>
			<input type="text" name="send[number]" class="form-control" value="<?php echo $edit['number'];?>" placeholder="Chapter number..." required />
			</p>
