        ...
        <table class="table table-hover">
          <tbody>
            <tr>
              ...
              <td class="col-lg-9">
                <input type="text" class="form-control prod-title input-size-medium" name="send[title]" value="<?php echo $theData['title'];?>" placeholder="Title" />
              </td>
            </tr>
            <tr>
              <td class="col-lg-3"><strong>Amount</strong></td>
              <td class="col-lg-9">
                <input type="text" class="form-control prod-title input-size-medium" value="<?php echo $theData['amount'];?>" name="send[amount]" placeholder="Amount" />
              </td>
            </tr>
            <tr>
