    ...
    <div class="panel panel-default">
      ...
      <hr>      
        ...
        <table class="table table-hover">
          <tbody>
            <tr>
              <td class="col-lg-3"><strong>Tax Name</strong></td>
              <td class="col-lg-9">
                <input type="text" class="form-control prod-title input-size-medium" name="send[title]" placeholder="Tax Name" />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td class="col-lg-3"><strong>Countries</strong></td>
              <td class="col-lg-9">
              <select name="countries[]" multiple class="form-control chosen-select">
                  <option value="all" selected="">All</option>
                  <?php if(isset($listCountries[0]['country_id'])){ ?>
                  <?php
                  ...
                  for ($i=0; $i < $total; $i++) { 
                      ...
                      $li.='<option value="'.strtolower($listCountries[$i]['iso_code_2']).'">'.$listCountries[$i]['name'].'</option>';
                  }
