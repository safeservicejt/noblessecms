    			...
    			<div class="col-lg-3">
                    <div class="input-group input-group-sm">
                        <select class="form-control" name="action">
                            ...
                            <option value="unpublish">Disable</option>
                        </select>
    					...
    					<?php
    						...
    						for ($i=0; $i < $total; $i++) { 
	    						...
	    						<tr>
                                    ...
                                    <td class="col-lg-9">Discount <span class="text-success">'.$theList[$i]['percent'].'%</span>
                                    From <strong>'.date('M d, Y',strtotime($theList[$i]['date_discount'])).'</strong> to <strong>'.date('M d, Y',strtotime($theList[$i]['date_enddiscount'])).'</strong>
                                    </td>
                                    <td class="col-lg-1 text-right">'.$status.'</td>
